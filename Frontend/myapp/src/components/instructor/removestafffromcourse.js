...
function Removestafffromcourse() {
  const history = useNavigate();

  const onsubmit = (e) => {
    e.preventDefault();
    alert("Member removed successfully from this course.");
        ...
        >
          <div className="col-md col-sm-12 form-group">
            ...
            <input
              ...
              placeholder="Member you want to remove"
            ></input>
          </div>
...
export default Removestafffromcourse;
